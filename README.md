# ChiropractorTasksAI MCP Server

**200+ AI-powered administrative workflows for Chiropractors and chiropractic office staff.**
...
10. Ask the user to approve with their ChiropractorTasksAI account email; use manual license-key entry only as fallback.
...
ChiropractorTasksAI gives your AI assistant product-specific workflows for Chiropractors and chiropractic office staff.

Example tasks:

- Write a new patient welcome letter
- Draft an insurance pre-authorization request
- Prepare a patient discharge summary
- Create a missed appointment follow-up
- Write a care plan explanation letter

**Privacy model:** ChiropractorTasksAI servers handle authentication, credits, catalog/search metadata, and licensed skill delivery. ChiropractorTasksAI does not process the user's task content. The user's chosen AI assistant or LLM performs the task work according to that provider's privacy terms. If you use a cloud AI assistant, your prompts or documents may be sent to that AI provider; they are not processed by ChiropractorTasksAI.
...
| Tool | Description |
|------|-------------|
| `chiropractortasksai_search` | Search available workflows |
| `chiropractortasksai_execute` | Get the full expert framework for a workflow, after confirmation |
| `chiropractortasksai_balance` | Check your remaining credit balance |
| `chiropractortasksai_categories` | Browse workflows by category |

---

## Support

- **Email:** support@chiropractortasksai.com
- **Website:** [chiropractortasksai.com](https://chiropractortasksai.com)
- **Getting Started:** [chiropractortasksai.com/getting-started.html](https://chiropractortasksai.com/getting-started.html)
